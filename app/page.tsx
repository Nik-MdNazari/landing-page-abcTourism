      ...
      <main id="main">
        <section className="hero" id="top">
          ...
          <div className="heroContent">
            ...
            <div className="heroActions"><a className="button" href="#how">Start listening <span>→</span></a><Link className="textLink" href="/how-it-works"><b>▶</b> See how it works</Link></div>
          </div>
